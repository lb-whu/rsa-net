...
### Generator layers
def adain(content, style,segy,segz, epsilon=1e-5):
    axes = [1,2]
...
def n_res_blocks(input,style,segy,segz, is_train,reuse, norm='instance', is_training=True, n=6):
  depth = input.get_shape()[3]
  for i in range(1,n+1):
    if i==4 or i==6 or i==9 :
      output = adain(input, style,segy = segy,segz = segz)
    else:
