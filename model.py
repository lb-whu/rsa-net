...
#        shape=[batch_size, image_size, image_size, 3])
  ...
  def model(self):  
    ...
    fake_y,fake_y1,fake_y2 = self.G(self.y,self.z,self.segy,self.segz)  
...
#    D_Y_loss = self.discriminator_loss(self.D_Y, sobel_y, sobel_fakey, use_lsgan=self.use_lsgan)*self.zf
    ...
    DiceLoss = self.unetLoss(self.Unet,self.x,fake_y)
        
        
    return G_gan_loss, D_loss,fake_y,DiceLoss,DiceTrain,seg
